...
export default function AdminPanel({ onCaseAdded, caseToEdit, onCloseEdit }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            alert(`Failed to ${isEditMode ? 'update' : 'add'} case.`);
            console.error(error);
        } finally {
        ...
        return (
            <div className="fixed bottom-6 right-6 z-50">
                <button 
                    ...
                    className="bg-blue-900 text-white rounded-full p-4 shadow-xl hover:bg-blue-800 transition-colors flex items-center justify-center group"
                >
            ...
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl overflow-hidden flex flex-col max-h-[90vh]">
                ...
                <div className="px-6 py-4 border-b border-gray-200 flex justify-between items-center bg-gray-50">
                    <h2 className="text-xl font-bold text-gray-900">
                        {isEditMode ? 'Edit Clinical Case' : 'Add New Clinical Case'}
                    </h2>
                ...
                <div className="p-6 overflow-y-auto flex-1">
                    <form id="add-case-form" onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">Presentation (Patient History)</label>
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">Lab Results & Diagnostics</label>
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">Diagnosis & Management</label>
                        ...
                        <div className="border border-gray-200 rounded-md p-4 bg-gray-50">
                            ...
                            <div className="flex items-center space-x-4">
                                ...
                                />
                                {isUploading && <span className="text-sm text-blue-600 font-medium whitespace-nowrap">Uploading...</span>}
                            </div>
                        ...
                        <div className="flex items-center pt-2">
                            <input type="checkbox" name="isPublished" checked={formData.isPublished} onChange={handleChange} className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded" />
                ...
                <div className="px-6 py-4 border-t border-gray-200 bg-gray-50 flex justify-end space-x-3">
                    ...
                    <button type="submit" form="add-case-form" disabled={isSubmitting || isUploading} className="px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 disabled:opacity-50">
                        {isSubmitting ? 'Saving...' : (isEditMode ? 'Update Case' : 'Save Clinical Case')}
                    </button>
                </div>
